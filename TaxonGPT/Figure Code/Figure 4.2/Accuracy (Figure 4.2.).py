...
file_path = "E:/Evaluate_results_for_all_datasets/Evaluate_table/Description/accuracy/accuracy.csv"  # You need to update the file path to your file path
...
plt.tight_layout()  # Layout adjustments to ensure content is displayed in its entirety

# Set the SVG save path
...
# Saved in SVG format (vector graphics)
plt.savefig(svg_output_path, format='svg', dpi=600)
