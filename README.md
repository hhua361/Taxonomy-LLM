...
The rapid development of Artificial Intelligence (AI), especially Large Language Models (LLMs), offers new opportunities to streamline taxonomic workflows given taxonomy’s extensive use of natural language. This study investigates the applications of LLMs in taxonomy and develops LLM-based research pipelines to demonstrate their practical potential. The research consists of three main components: (1) a pilot study (Chapter 2), designed to select relevant taxonomic data types, evaluates the current potential of LLMs in taxonomy, and explores the integration of Prompt Engineering and Knowledge Graph (KG) techniques into LLM-based taxonomic tasks; (2) the Description to Matrix (DtoM) pipeline (Chapter 3), which utilizes ChatGPT-4o within a Python environment to automatically extract morphological characters from unstructured descriptions and convert them into structured data matrices; and (3) TaxonGPT (Chapter 4), which uses LLMs to automatically generate taxonomic descriptions and taxonomic keys from morphological matrices, by integrating knowledge graphs and error-checking modules to reduce 'AI hallucinations' and enhance accuracy.

Experimental results indicate that DtoM accurately transforms unstructured taxonomic descriptions into structured matrices across multiple datasets. TaxonGPT further highlights the potential of LLMs in taxonomy, with benchmark evaluations confirming significant performance in accuracy, efficiency, and reproducibility. Despite these promising findings, limitations in training data can induce biases in specialized fields, resulting in variable performance in taxonomic classification across different taxa and incurring high computational costs. Future research could focus on improving LLMs stability to enable more reliable large-scale taxonomic studies. As an exploratory AI-driven study, this research validates the feasibility of employing LLMs for automated taxonomy tasks while ensuring high accuracy, laying the foundation for more comprehensive intelligent taxonomy research.
...
## Acknowledgements
Just like a puzzle, this thesis came together with the invaluable contributions of many people, to whom I am sincerely grateful.

First and foremost, I would like to express my gratitude to my supervisor, Prof. Allen Rodrigo. Throughout this project, I had regular weekly meetings, and before each meeting, I always felt a bit nervous. Allen would often end with the question: “So, what do you think is the next step?” Looking back over the past year, this simple question has given me tremendous motivation and strength. Through his patient guidance and thought-provoking questions, Allen has helped me develop a deeper understanding of scientific research and has made the academic journey even more engaging for me. His unwavering support and understanding have been invaluable, and his encouragement has provided me with the confidence to keep moving forward. Moreover, his humor and optimistic outlook have been truly inspiring, making this journey not only intellectually enriching but also enjoyable.

I am also deeply grateful to my co-supervisor, Dr. Teng Li. If this research project were a voyage, then Allen would be the captain, Dr. Li would be the first mate. He provided crucial guidance, ensuring I stayed on course, especially in critical moments. During this 'voyage', Our in-depth discussions often sparked valuable insights and fresh ideas, and his support in overcoming challenges was invaluable. I am also grateful to my other co-supervisor, Dr. David Seldon, for his invaluable support and guidance throughout my research.

Lastly, I would like to express my deepest gratitude to my family for their unwavering support. Their encouragement, belief in me, and patient companionship have given me the strength and courage to face any challenge. I wish to extend my appreciation to everyone I have encountered throughout this research journey. As Hermann Hesse wrote in Siddhartha, "What we call 'I' is just a sum of all that we have ever experienced." I am deeply grateful for the companionship, support, and encouragement from all who have been part of this journey. This research experience will always be a treasured chapter in my life, a new beginning rather than an end.

"My last tribute is to those who know I am not perfect but still love me." — Rabindranath Tagore
